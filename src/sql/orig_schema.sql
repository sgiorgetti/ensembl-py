...
CREATE OR REPLACE TABLE assembly (

  asm_seq_region_id           UINTEGER NOT NULL,
  cmp_seq_region_id           UINTEGER NOT NULL,
...
CREATE INDEX cmp_seq_region_idx (cmp_seq_region_id);
CREATE INDEX asm_seq_region_idx (asm_seq_region_id, asm_start);

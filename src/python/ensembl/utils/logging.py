...
__all__ = ["LogLevel", "init_logging", "init_logging_with_args", "init_logging_debug"]
...
def init_logging_debug(
    log_level: LogLevel = "DEBUG",
    log_file: Optional[Path] = None,
    log_file_level: LogLevel = "DEBUG",
    msg_format: str = "%(asctime)s\t%(name)-12s\t%(levelname)s\t%(message)s",
    date_format: str = r"%Y-%m-%d_%H:%M:%S"
) -> None:
    """Initialises the logging system.
